...
<body class="font-montserrat">
    ...
    <section class="w-full py-24 bg-gray-100 text-center fade-up">
        <h2 class="text-4xl font-bold mb-14">Lokasi Strategis</h2>
        <div class="mx-20 grid grid-cols-4 gap-6 px-20">
            <div class="bg-white p-6 rounded-xl shadow-md">
                <img src="img/0km.png" alt="0 KM Jalan Poros Kota Batu" class="h-32 w-full object-cover rounded-md mb-4 h-44">
                <h3 class="font-bold">0 KM Jalan Poros <br> Kota Batu</h3>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-md">
                <img src="img/jatimpark3.png" alt="Selangkah dari Jatim Park 3" class="h-32 w-full object-cover rounded-md mb-4 h-44">
                <h3 class="font-bold">Selangkah dari <br>Jatim Park 3</h3>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-md">
                <img src="img/umm.png" alt="5 Menit dari Univ. Muhammadiyah Malang" class="h-32 w-full object-cover rounded-md mb-4 h-44">
                <h3 class="font-bold">5 Menit dari Univ. <br> Muhammadiyah <br>Malang</h3>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-md">
                <img src="img/alunalunbatu.png" alt="10 Menit dari Alun-Alun Batu" class="h-32 w-full object-cover rounded-md mb-4 h-44">
                <h3 class="font-bold">10 Menit dari <br> Alun-Alun Batu</h3>
            </div>
        </div>
        <div class="mt-10 mx-40 bg-white p-12 rounded-xl shadow-md flex items-center">
            <img src="img/villa.png" alt="Peluang Investasi" class="h-32 w-1/3 object-cover rounded-md">
            <div class="ml-6 text-left">
                <h3 class="font-bold text-lg">Tingginya Jumlah Wisatawan Jadi Peluang!</h3>
                <p class="text-gray-700 mt-2">Dengan kunjungan lebih dari 10 juta wisatawan setiap tahun, Kota Batu menawarkan peluang investasi villa yang menjanjikan. Potensi tingkat okupansi yang tinggi didukung oleh daya tarik wisata populer seperti Jatim Park 3, BNS, dan Alun-Alun Batu, menjadikan Kota Batu sebagai destinasi investasi yang menguntungkan.</p>
            </div>
        </div>
    </section>
